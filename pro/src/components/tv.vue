<template>
  <div>
    ...
    <div class="recom">
      <div class="mov" v-for="(item,index) of tvrecommend" :key="index">
        <div>
...
export default {
  ...
  methods: {
    load() {
      this.axios.get("rectv").then(res => {
        console.log(res);
        this.tvrecommend = res.data.tvrecommend;
        // this.weeklist = res.data.weeklist;
        // this.toplist = res.data.toplist;
        // console.log(this.recommend);
        for (var i of res.data.tvrecommend) {
